...
import 'package:internal_base/common/otp_under_line_view/otp_field_style.dart';
import 'package:internal_base/common/otp_under_line_view/otp_style.dart';
  ...
  Widget buildTextField(BuildContext context, int index) {
    ...
    return Container(
      ...
      child: TextField(
        ...
        style: getTextRegular(size: SizeConstants.s1*18, colors: Colors.black),
