...
class GetWarehouseManagerProductsDetailsRepository {
  ...
  Future<dynamic> fetchGetWarehouseManagerProductsDetails(
      dynamic mGetWarehouseManagerProductsDetailsRequest) async {
    final response = await webservice.getWithAuthAndStringRequest(
        WebConstants.actionGetWarehouseManagerProductsDetails,
        mGetWarehouseManagerProductsDetailsRequest);

    try {
      WebCommonResponse mWebCommonResponse =
          WebCommonResponse.fromJson(response);
      if (mWebCommonResponse.statusCode.toString() == "200") {
        GetWarehouseManagerProductsDetailsResponse dashboardResponse =
            GetWarehouseManagerProductsDetailsResponse.fromJson(
