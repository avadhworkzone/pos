...
class GetWarehouseManagerProductsListRepository {
  ...
  Future<dynamic> fetchGetWarehouseManagerProductsList(
      dynamic mGetWarehouseManagerProductsListRequest) async {
    final response = await webservice.getWithAuthAndClassQueryRequest(
        WebConstants.actionGetWarehouseManagerProductsList,
    ...
    try {
      ...
      if (mWebCommonResponse.statusCode.toString() == "200") {
        GetWarehouseManagerProductsListResponse dashboardResponse =
            GetWarehouseManagerProductsListResponse.fromJson(
