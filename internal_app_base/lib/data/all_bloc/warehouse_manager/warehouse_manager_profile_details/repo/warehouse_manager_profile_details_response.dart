...
class GetWarehouseManagerProfileDetailsResponse {
  GetWarehouseManagerProfileDetailsResponse({
    this.warehouseManagerDetails,});

  GetWarehouseManagerProfileDetailsResponse.fromJson(dynamic json) {
    warehouseManagerDetails = json['warehouse_manager_details'] != null ? WarehouseManagerDetails.fromJson(json['warehouse_manager_details']) : null;
  }
  WarehouseManagerDetails? warehouseManagerDetails;

  Map<String, dynamic> toJson() {
    final map = <String, dynamic>{};
    if (warehouseManagerDetails != null) {
      map['warehouse_manager_details'] = warehouseManagerDetails?.toJson();
    }
    return map;
  }
...
class WarehouseManagerDetails {
  ...
  WarehouseManagerDetails.fromJson(dynamic json) {
    id = json['id'];
