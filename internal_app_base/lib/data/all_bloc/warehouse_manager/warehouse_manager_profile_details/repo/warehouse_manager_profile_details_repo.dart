...
class GetWarehouseManagerProfileDetailsRepository {
  ...
  Future<dynamic> fetchGetWarehouseManagerProfileDetails(
      dynamic mGetWarehouseManagerProfileDetailsRequest) async {
    final response = await webservice.getWithAuthAndStringRequest(
        WebConstants.actionGetWarehouseManagerProfileDetails,
    ...
    try {
      ...
      if (mWebCommonResponse.statusCode.toString() == "200") {
        GetWarehouseManagerProfileDetailsResponse dashboardResponse =
            GetWarehouseManagerProfileDetailsResponse.fromJson(
