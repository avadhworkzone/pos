...
class GetPromoteProfileDetailsResponse {
  GetPromoteProfileDetailsResponse({
    this.promoterDetails,});

  GetPromoteProfileDetailsResponse.fromJson(dynamic json) {
    promoterDetails = json['promoter_details'] != null ? PromoterDetails.fromJson(json['promoter_details']) : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (promoterDetails != null) {
      map['promoter_details'] = promoterDetails?.toJson();
    }
    return map;
  }
...
class PromoterDetails {
  ...
  PromoterDetails.fromJson(dynamic json) {
    id = json['id'];
