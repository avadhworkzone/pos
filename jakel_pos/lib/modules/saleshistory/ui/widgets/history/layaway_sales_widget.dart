...
class LayawaySalesWidget extends StatefulWidget {
  final Function onSelected;

  const LayawaySalesWidget({Key? key, required this.onSelected})
      : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return _LayawaySalesWidgetState();
  }
}

class _LayawaySalesWidgetState extends State<LayawaySalesWidget> {
  ...
  void _getSales() {
    viewModel.getLayawaySales(pageNo, perPage, 0, 0);
  }
      ...
      builder: (context, snapshot) {
        ...
        if (snapshot.connectionState == ConnectionState.active) {
          ...
          if (responseData != null &&
              responseData.pendingLayawaySales != null) {
            salesResponse = responseData;
            sales = responseData.pendingLayawaySales;
  ...
  Widget showSalesList() {
    ...
    filtered = viewModel.filterSales(sales!, searchText);
