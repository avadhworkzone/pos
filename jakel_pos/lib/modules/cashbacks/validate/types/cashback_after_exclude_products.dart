...
class CashBackAfterExcludeProducts with BaseCashBacks {
  @override
  String title() {
    return "Some of the products are excluded in this cashback";
  }
  ...
  bool isValidForThisCart(CartSummary cartSummary, Cashbacks cashback) {
    ...
    if (cartSummary.getPayableExcludingProducts(cashback.products ?? []) >
