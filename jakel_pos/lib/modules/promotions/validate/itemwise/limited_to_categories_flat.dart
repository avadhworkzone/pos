...
class LimitedToCategoriesFlat with BasePromotion {
  final tag = "LimitedToCategoriesFlat";

  @override
  String samples() {
    return "Item Wise limited to categories & flat";
  }

  @override
  String title() {
    return "ITEM_WISE_LIMITED_TO_CATEGORIES_FLAT";
  }
