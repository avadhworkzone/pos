...
class QtyBuyXGetYPriceOffOnOthers with BasePromotion {
  final tag = "QtyBuyXGetYPriceOffOnOthers";
  ...
  @override
  String samples() {
    return "ITEM_WISE_BUY_2_GET_RM_50_OFF_ON_OTHERS";
  }

  @override
  String title() {
    return "Item Wise Buy 2 Get Rm 50 Off On Others";
  }
      ...
      for (var cartItem in cheapestItems) {
        if (!isGetQtyThresholdReached && _isGetProduct(cartItem, promotions)) {
          double discountPercent =
              cartItem.getDiscountPercentFromFlat((value.flatAmount ?? 0));

          setItemWisePromotionDataToItem(
              cartItem, promotions, groupId, discountPercent);
