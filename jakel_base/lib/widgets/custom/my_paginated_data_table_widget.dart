...
class PaginatedDataTableWidget extends StatefulWidget {
  ...
  @override
  PaginatedDataTableWidgetState createState() =>
      PaginatedDataTableWidgetState();
}
...
class PaginatedDataTableWidgetState extends State<PaginatedDataTableWidget> {
  late int _firstRowIndex = -1;
  late int _oldFirstRowIndex = -1;
  late int _rowCount;
  late bool _rowCountApproximate;
  int _selectedRowCount = 0;
  final Map<int, DataRow?> _rows = <int, DataRow?>{};
  static bool _bHandleFirst = false;

  set bHandleFirst(value) {
    _bHandleFirst = value;
  }

  get bHandleFirst => _bHandleFirst;
  ...
  void _handlePrevious() {
    _oldFirstRowIndex = _firstRowIndex;
  ...
  Widget build(BuildContext context) {
    ...
    final List<Widget> footerWidgetsLeft = <Widget>[];
    final List<Widget> footerWidgetsRight = <Widget>[];
    if (widget.onRowsPerPageChanged != null) {
      ...
      footerWidgetsLeft.addAll(<Widget>[
        Container(width: 14.0),
        // to match trailing padding in case we overflow and end up scrolling
        Text(localizations.rowsPerPageTitle),
        ConstrainedBox(
      ...
      footerWidgetsRight.addAll(<Widget>[
        Container(width: 14.0),
        // to match trailing padding in case we overflow and end up scrolling
        Text(localizations.rowsPerPageTitle),
        ConstrainedBox(
                ...
                Column(
                  ...
                  children: <Widget>[
                    ...
                    Expanded(child: Container(
                      margin: EdgeInsets.only(bottom: hight*0.075),
                        child:
                        Scrollbar(
                          ...
                          child: SingleChildScrollView(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Row(children: footerWidgetsLeft),
                                Row(children: footerWidgetsRight),
                              ],
                            ),
                          ),
                        ),
