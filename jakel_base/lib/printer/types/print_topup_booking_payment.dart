...
Future<bool> printTopUpBookingPayment(String? title,
    BookingPaymentTopUp bookingPayment, bool duplicateCopy) async {
...
pw.Widget getItemsAmountWidget(BookingPaymentTopUp sale) {
...
List<pw.TableRow> amountsRows(BookingPaymentTopUp sale) {
...
List<pw.Widget> getId(BookingPaymentTopUp sale) {
