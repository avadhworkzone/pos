...
class WarehouseManagerProductListRowWidget extends StatelessWidget {
  final int index;
  final WarehouseManagerProductListScreenModel
      mWarehouseManagerProductListScreenModel;
  final Products mProducts;

  const WarehouseManagerProductListRowWidget(
      this.index, this.mWarehouseManagerProductListScreenModel, this.mProducts,
      {super.key});
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        mWarehouseManagerProductListScreenModel.mCallbackModel.sValue =
            mProducts.id.toString();
        Navigator.pushNamed(
            context, RouteConstants.rWarehouseManagerProductDetailsScreenWidget,
            arguments: mWarehouseManagerProductListScreenModel.mCallbackModel);
      },
      child: Container(
