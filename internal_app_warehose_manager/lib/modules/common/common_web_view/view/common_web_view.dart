...
import 'package:internal_app_warehose_manager/modules/common/common_web_view/model/web_model.dart';
...
class CommonWebView extends StatefulWidget {
  ...
  const CommonWebView({Key? key, required this.sWebView}) : super(key: key);
