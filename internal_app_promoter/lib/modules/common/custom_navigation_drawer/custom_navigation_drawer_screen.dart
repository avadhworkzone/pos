...
import 'package:internal_app_promoter/modules/common/custom_navigation_drawer/model/custom_navigation_drawer_model.dart';
...
class _CustomNavigationDrawerState extends State<CustomNavigationDrawer> {
            ...
            children: [
              ...
              Expanded(
                ...
                child: Column(children: [
                  ...
                  ///Commission
                  _buildSideMenuItemAsset(
                      mCustomNavigationDrawerModel.getCommissionAssets(),
                      AppConstants.cWordConstants.wCommissionText,
                      RouteConstants.rPromoterCommissionListScreenWidget),

                  ///SalesReturns
                  _buildSideMenuItemAsset(
                      mCustomNavigationDrawerModel.getSaleReturnAssets(),
                      AppConstants.cWordConstants.wSalesReturnsText,
                      RouteConstants.rPromoterSalesReturnsListScreenWidget),

                  ///ProductList
                  _buildSideMenuItemAsset(
                      mCustomNavigationDrawerModel.getProductListAssets(),
                      AppConstants.cWordConstants.wProductListText,
                      RouteConstants.rPromoterProductListScreenWidget),
                  ...
                  _buildSideMenuItemIcon(
                      ...
                      RouteConstants.rPromoterHomeAddMemberScreenWidget),
  ...
  _buildSideMenuItemAsset(String icon, String title, String navRoute,
      [dynamic args]) {
    return Container(
      margin: EdgeInsets.only(left: SizeConstants.s1*15,right: SizeConstants.s1*15,top: SizeConstants.s1*15),
